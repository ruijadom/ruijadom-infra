...
describe("Footer", () => {
  ...
  it("renders a nav element with social links", () => {
    ...
    ).toHaveAttribute("href", "https://github.com/ruijadom-design");
    expect(
      withinNavSocial.getByRole("link", {
        name: "Turbo Monorepo on Mastodon",
      }),
    ).toHaveAttribute("href", "https://hachyderm.io/@ruijadom-design");
    expect(
      withinNavSocial.getByRole("link", {
        name: "Turbo Monorepo on Twitter",
      }),
    ).toHaveAttribute("href", "https://twitter.com/ruijadom-design");
  });
});
